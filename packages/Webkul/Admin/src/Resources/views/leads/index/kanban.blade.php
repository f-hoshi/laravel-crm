                    ...
                    >
                        ...
                        >
                            ...
                            <template #item="{ element, index }">
                                ...
                                <a
                                    class="lead-item flex cursor-pointer flex-col gap-5 rounded-md border border-gray-200 bg-gray-50 p-2 dark:border-gray-400 dark:bg-gray-400"
                                ...
                                >
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        <span class="icon-organization text-sm"></span>
